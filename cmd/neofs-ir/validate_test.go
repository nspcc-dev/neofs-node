...
func TestCheckForUnknownFieldsExample(t *testing.T) {
	...
	require.Equal(t, *cfg, config.Config{
		...
		Timers: config.Timers{
			StopEstimation: config.BasicTimer{
				Mul: 1,
				Div: 4,
			},
			CollectBasicIncome: config.BasicTimer{
				Mul: 1,
				Div: 2,
			},
			DistributeBasicIncome: config.BasicTimer{
				Mul: 3,
				Div: 4,
			},
		},
		...
		Contracts: config.Contracts{
			...
			Reputation: "d793b842ff0c103fe89e385069e82a27602135ff",
			Alphabet: config.Alphabet{
				Az:      "c1d211fceeb4b1dc76b8e4054d11fdf887e418ea",
				Buky:    "e2ba789320899658b100f331bdebb74474757920",
				Vedi:    "9623c11fd49aa18220458fbaae0396749c669e19",
				Glagoli: "39617441b8e06c55e4fc3ce660be9101b6c1f866",
				Dobro:   "e6122b65d45c8feeb04455d67814394c147ed4d1",
				Yest:    "cdbca5cb5d48a4472923844d0e3ee6328cf86d38",
				Zhivete: "f584699bc2ff457d339fb09f16217042c1a42101",
			},
		},

...
func (o objectSource) Search(ctx context.Context, cnr cid.ID, filters objectSDK.SearchFilters, childV2 bool) ([]client.SearchResultItem, error) {
	var attrs []string
	count := uint32(1)
	if !childV2 {
		count = 1000
		attrs = []string{objectSDK.FilterPayloadSize}
	}

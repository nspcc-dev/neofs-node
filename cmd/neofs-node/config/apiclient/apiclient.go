...
const (
	...
	// MinConnTimeDefault is a default minimum time of established connection in NeoFS API client.
	MinConnTimeDefault = 20 * time.Second
	// PingIntervalDefault is a default interval between pings in NeoFS API client.
	PingIntervalDefault = 10 * time.Second
	// PingTimeoutDefault is a default timeout of a single ping in NeoFS API client.

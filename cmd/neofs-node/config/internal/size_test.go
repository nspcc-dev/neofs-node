...
`
	...
	require.EqualValues(t, tb/2, cfg.SizeFloat, "size_float")
	require.EqualValues(t, uint64(14*gb+(gb*123/1000/mb*mb)), cfg.SizeFloatBig, "size_float_big")
	require.EqualValues(t, 12, cfg.SizeIAmNotVeryClever, "size_i_am_not_very_clever")

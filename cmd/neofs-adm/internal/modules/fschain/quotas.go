...
var (
	...
	quotasContainerCmd = &cobra.Command{
		Use:     "container",
		...
		RunE:    quotasContainerFunc,
		Args:    quotaArgCheckFunc,
	}

	quotasUserCmd = &cobra.Command{
		Use:     "user",
...
func quotasContainerFunc(cmd *cobra.Command, args []string) error {
	var cID cid.ID
	...
	if len(args) == 0 {
		...
		_, err = act.WaitSuccess(txH, vub, err)
		if err != nil {
...
func quotasUserFunc(cmd *cobra.Command, args []string) error {

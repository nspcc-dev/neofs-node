...
func testPeers(is *require.Assertions, a multiaddr.Multiaddr) peers.Interface {
	s, err := peers.New(peers.Params{
		Address:   a,
...
func TestSuite(t *testing.T) {
	...
	t.Run("it should work with gRPC", func(t *testing.T) {
		...
		con, err := ps.GRPCConnection(ctx, addr, false)
		is.NoError(err)

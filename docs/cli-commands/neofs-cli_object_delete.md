...
```
  ...
  -r, --rpc-endpoint string            Remote node address (as 'multiaddr' or '<host>:<port>')
      ...
      --session-subjects strings       Session subject user IDs (optional, defaults to all network nodes)
      --session-subjects-nns strings   Session subject NNS names (optional, defaults to all network nodes)

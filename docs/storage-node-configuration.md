...
| `shards_default`           | [Shard config](#shard-config) |               | Configuration for default values in shards.                                                                                                                                                                                                 |
| `shards`                   | [Shard config](#shard-config) |               | Configuration for seprate shards.                                                                                                                                                                                                           |

## `shard` config

Contains configuration of shards.
`shards` subsection contains an array of configurations for each shard.
`shards_default` subsection has the same format and specifies defaults for missing values.

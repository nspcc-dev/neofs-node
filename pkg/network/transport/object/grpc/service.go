...
type Node interface {
	...
	// StoreObject saves given NeoFS object into local object storage of the Node.
	// StoreObject is called only when the Node complies with the container's
	// storage policy.
	StoreObject(objectsdk.Object) error
}

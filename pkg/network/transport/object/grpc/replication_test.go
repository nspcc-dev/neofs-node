...
func (x *noCallTestNode) StoreObject(object.Object) error {
	panic("must not be called")
}
...
func (x *testNode) StoreObject(obj object.Object) error {
...
func (x nopNode) StoreObject(object.Object) error {
	return nil
}

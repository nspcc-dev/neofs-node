...
var errUnsupportedQueryVersion = errors.New("unsupported query version number")

var errSearchQueryUnmarshal = errors.New("query unmarshal failure")

var errLocalQueryImpose = errors.New("local query imposing failure")

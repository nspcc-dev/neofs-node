...
func newRawServiceOnlyConn(t *testing.T, svc *grpc.ServiceDesc) clientcore.MultiAddressClient {
	...
	grpcSrv.RegisterService(svc, nil)
	...
	require.NoError(t, err) // lib misuse or internal error

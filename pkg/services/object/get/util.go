...
func (w *DirectChildWriter) WriteChunk(p []byte) error {
	return w.dest.WriteChunk(p)
}

func (w *DirectChildWriter) Object() *object.Object { return w.obj }
func (w *DirectChildWriter) HeaderSet() bool        { return w.headerSet }

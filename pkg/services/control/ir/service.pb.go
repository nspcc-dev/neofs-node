...
func (x *NotaryRequestRequest_Body) GetArgs() []string {
	if x != nil {
		return x.Args
	}
	return nil
...
var file_pkg_services_control_ir_service_proto_rawDesc = []byte{
	...
	0x18, 0x02, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x61, 0x72, 0x67, 0x73, 0x22, 0xa2, 0x01, 0x0a,
	...
	0x73, 0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x88,
...
func file_pkg_services_control_ir_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_services_control_ir_service_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[12].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[13].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[14].Exporter = func(v any, i int) any {
		...
		file_pkg_services_control_ir_service_proto_msgTypes[15].Exporter = func(v any, i int) any {

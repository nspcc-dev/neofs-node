...
func (x *TransactionInfo) StableSize() (size int) {
	size += proto.BytesSize(1, x.Script)
	size += proto.StringSize(2, x.Hash)
	return size
}
...
func (x *TransactionInfo) StableMarshal(buf []byte) []byte {
	...
	var offset int
	offset += proto.BytesMarshal(1, buf[offset:], x.Script)
	offset += proto.StringMarshal(2, buf[offset:], x.Hash)
	return buf
}

...
// correspond to testAddress and depth=1.
const (
	testObjectDir = "E"
	// in testObjectDir.
	testObjectFileName = "9A82e5awsXzDz4FHEmoz81sVU4c3EQzd1oVM122RVST.BVBcG4LStyX486XkjmwcXytTsiEsed2tPkxEP8USaV4g"
)
...
func newOneTimeInitPutMetric(t *testing.T, objectLen uint64) *oneTimeInitPutMetric {
...
func (x *oneTimeInitPutMetric) AddWCInitPutDuration(shardID string, dur time.Duration) {
	require.Equal(x.t, testShardIDString, shardID)

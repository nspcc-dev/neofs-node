...
const (
	...
	// gcContainerMark key stored in metadata bucket to mark whole container as GC-marked
	gcContainerMark = "gc_container_mark"
)
...
var (
	...
	containerGCMarkKey = []byte(gcContainerMark)

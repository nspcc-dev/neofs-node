...
func newObject(t testing.TB) *object.Object {
	...
	x.SetPayloadHomomorphicHash(checksum.New(checksum.TillichZemor, []byte("legacy TZ checksum"))) //nolint:staticcheck // this is a test and such objects are possible
	return x
}

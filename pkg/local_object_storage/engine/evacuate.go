...
func (e *StorageEngine) Evacuate(shardIDs []*coreshard.ID, ignoreErrors bool, faultHandler func(oid.Address, *object.Object) error) (int, error) {
	...
	var shards = slices.Collect(maps.Values(e.shards))
	e.mtx.RUnlock()

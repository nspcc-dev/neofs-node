...
func TestFormatValidator_Validate(t *testing.T) {
	...
	t.Run("invalid signature", func(t *testing.T) {
		...
		t.Run("too big verification script", func(t *testing.T) {
			...
			require.EqualError(t, v.Validate(&obj, false), "authenticate: verification script len 1025 overflows limit 1024")
		})
		t.Run("too big invocation script", func(t *testing.T) {
			...
			obj.SetSignature(&sig)
			require.EqualError(t, v.Validate(&obj, false), "authenticate: invocation script len 1025 overflows limit 1024")
		})
		t.Run("too big invocation script", func(t *testing.T) {

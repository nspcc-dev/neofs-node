...
func TestFormatValidator_Validate(t *testing.T) {
	...
	t.Run("invalid signature", func(t *testing.T) {
		t.Run("unsigned", func(t *testing.T) {
			...
			require.EqualError(t, v.Validate(&obj, false), "(*object.FormatValidator) could not validate signature key: missing signature")
		})
		t.Run("unsupported scheme", func(t *testing.T) {
			...
			require.EqualError(t, v.Validate(&obj, false), "(*object.FormatValidator) could not validate header fields: invalid signature")
		})
			...
			for _, tc := range []struct {
				...
				t.Run(tc.scheme.String(), func(t *testing.T) {
					...
					for i := range validSig {
						...
						require.EqualError(t, v.Validate(&tc.object, false), "(*object.FormatValidator) could not validate header fields: invalid signature")
					}
				})
			}
		})

...
type MultiAddressClient interface {
	...
	// RawForAddress passed opens [grpc.ClientConn] to each sub-address
	// of the passed network.Address until success.
	RawForAddress(network.Address, func(*grpc.ClientConn) error) error

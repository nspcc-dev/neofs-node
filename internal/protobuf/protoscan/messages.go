...
var (
	...
	ResponseStatusScheme = MessageScheme{
		fields: map[protowire.Number]namedField{
			...
			protostatus.FieldStatusMessage: newNamedField("message", fieldTypeString),
	...
	ResponseVerificationHeaderScheme = MessageScheme{
		fields: map[protowire.Number]namedField{
			protosession.FieldResponseVerificationHeaderBodySignature:   newNamedField("body signature", fieldTypeNestedMessage),
			protosession.FieldResponseVerificationHeaderMetaSignature:   newNamedField("meta signature", fieldTypeNestedMessage),
			protosession.FieldResponseVerificationHeaderOriginSignature: newNamedField("origin signature", fieldTypeNestedMessage),
			protosession.FieldResponseVerificationHeaderOrigin:          newNamedField("origin", fieldTypeNestedMessage),
		},
		nestedFields: map[protowire.Number]MessageScheme{
		...
		recursionFields: []protowire.Number{protosession.FieldResponseVerificationHeaderOrigin},
	}
	ResponseScheme = MessageScheme{
		fields: map[protowire.Number]namedField{
			...
			protobuf.FieldResponseVerificationHeader: newNamedField("verification header", fieldTypeNestedMessage),
		},
		nestedFields: map[protowire.Number]MessageScheme{

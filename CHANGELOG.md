...
- In-object session token signed not by its issuer is no longer passed (#3216)
...
- Tokens' signature verification errors are more detailed in status responses now (#3216)
